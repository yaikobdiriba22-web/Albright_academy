...
const DEFAULT_SETTINGS: SchoolSettings = {
  ...
  email: 'info@albrightacademy.edu',
  address: 'Bole Sub-City, Next to Millennium Park, Addis Ababa, Ethiopia',
  mapsUrl: 'https://maps.google.com/?q=Addis+Ababa+Ethiopia',
  latitude: 9.010793,
  longitude: 38.761252,
  ...
  return {
    ...
    applications: [
      ...
      },
      {
        ...
        applyingGrade: 'KG1',
        previousSchool: '',
        guardianName: 'Dr. Girma Kassa',
        guardianPhone: '+251 922 456 789',
        guardianEmail: 'gkassa@health.example',
        address: 'CMC Michael, Addis Ababa',
        emergencyContact: '+251 933 112 244',
        additionalInformation: 'First time entering formal preschool.',
        status: 'Reviewing',
      ...
      {
        id: 'app-3',
        referenceNumber: 'ALB-2026-0003',
        firstName: 'Ephrem',
        middleName: 'Yohannes',
        lastName: 'Bekele',
        dateOfBirth: '2014-11-03',
        gender: 'Male',
        applyingGrade: 'Grade 6',
        previousSchool: 'Hilltop International School',
        guardianName: 'Yohannes Bekele',
        guardianPhone: '+251 911 887 766',
        guardianEmail: 'yohannes.b@fin.example',
        address: 'Old Airport, Addis Ababa',
        emergencyContact: '+251 911 887 767',
        additionalInformation: 'Excels in robotics and junior mathematics olympiad.',
        status: 'New',
    ...
    news: [
      {
        ...
        summary:
          'Students from Grade 1 to 8 will showcase interactive science prototypes, automated micro-garden projects, and junior programming achievements.',
...
Parents, community mentors, and technology leaders are cordially invited to witness our young innovators demonstrating that tomorrow's breakthroughs begin with curiosity in today's classrooms.
...
• Creative sensorial engineering displays by KG scholars`,
      ...
      },
      {
        ...
        content: `Reading opens the gates to empathy and boundless imagination. Albright Academy has officially opened its revamped Media & Reading Sanctuary, equipped with ergonomic reading spaces, age-appropriate encyclopedias, bilingual African and international literature, and guided digital research stations.
...
Every class has designated weekly library discovery hours supervised by certified literacy coaches.`,
      ...
      },
      {
        ...
        content: `Nurturing mutual respect and cultural appreciation starts in early childhood. Our KG scholars brought our central amphitheatre alive with radiant colors, regional songs, and joyful dance performances alongside their teachers and families.`,
        imageUrl:
    ...
    gallery: [
      ...
      {
        id: 'gal-5',
        title: 'Annual Sports Day Track Sprint',
        description: 'Cheering on our student athletes striving for personal excellence.',
        imageUrl:
          'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?auto=format&fit=crop&w=1000&q=80',
        category: 'Sports',
      ...
      {
        id: 'gal-6',
        title: 'Junior Choir and String Ensemble',
        description: 'Scholars performing at the annual Spring Music Gala.',
        imageUrl:
          'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?auto=format&fit=crop&w=1000&q=80',
        category: 'Events',
    ...
    messages: [
      {
        ...
        message:
          'Good day. I am seeking information regarding entrance assessments for our daughter who is currently finishing KG3. Could you kindly provide the fee schedule and orientation dates?',
        isRead: false,
      ...
      },
      {
        id: 'msg-2',
        name: 'Samuel Abera',
        email: 'samuel.a@techcorp.example',
        phone: '+251 922 778 899',
        subject: 'STEM Robotics Club Sponsorship Proposal',
        message:
          'We are an IT firm located nearby and would love to support Albright Academy with hardware kits for the upcoming STEM Expo.',
        isRead: true,
