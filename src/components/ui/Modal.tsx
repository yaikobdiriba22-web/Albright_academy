...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    ...
    >
      <div
        id="modal-panel"
        className={`w-full ${maxWidthClasses[chosenWidth]} bg-white rounded-2xl shadow-2xl border border-slate-200 overflow-hidden my-8 animate-in fade-in zoom-in-95 duration-150`}
      >
